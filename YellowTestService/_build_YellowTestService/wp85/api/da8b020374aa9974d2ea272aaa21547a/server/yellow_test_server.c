...
#include "yellow_test_server.h"
#include "yellow_test_messages.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("yellow_test_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("yellow_test_ServerHandlers", 3);
...
static void Handle_yellow_test_CheckSimState
(
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_CheckSimState (  );
...
static void Handle_yellow_test_MeasureSignalStrength
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_MeasureSignalStrength ( 
        qualPtr );
...
static void Handle_yellow_test_MainBusI2C
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_MainBusI2C (  );
...
static void Handle_yellow_test_Port1HubI2C
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_Port1HubI2C (  );
...
static void Handle_yellow_test_Port2HubI2C
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_Port2HubI2C (  );
...
static void Handle_yellow_test_Port3HubI2C
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_Port3HubI2C (  );
...
static void Handle_yellow_test_AcceGyroRead
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = yellow_test_AcceGyroRead ( 
        reg, 
        dataPtr );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_yellow_test_CheckSimState : Handle_yellow_test_CheckSimState(msgRef); break;
        case _MSGID_yellow_test_MeasureSignalStrength : Handle_yellow_test_MeasureSignalStrength(msgRef); break;
        case _MSGID_yellow_test_MainBusI2C : Handle_yellow_test_MainBusI2C(msgRef); break;
        case _MSGID_yellow_test_Port1HubI2C : Handle_yellow_test_Port1HubI2C(msgRef); break;
        case _MSGID_yellow_test_Port2HubI2C : Handle_yellow_test_Port2HubI2C(msgRef); break;
        case _MSGID_yellow_test_Port3HubI2C : Handle_yellow_test_Port3HubI2C(msgRef); break;
        case _MSGID_yellow_test_AcceGyroRead : Handle_yellow_test_AcceGyroRead(msgRef); break;
