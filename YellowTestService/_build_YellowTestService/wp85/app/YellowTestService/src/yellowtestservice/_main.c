...
// Startup code for the executable 'yellowtestservice'.
...
LE_SHARED const char* _YellowTestServiceComponent_yellow_test_ServiceInstanceName = "yellow_test";
LE_SHARED const char* _YellowTestServiceComponent_le_sim_ServiceInstanceName = "yellowtestservice.YellowTestServiceComponent.le_sim";
LE_SHARED const char* _YellowTestServiceComponent_le_mrc_ServiceInstanceName = "yellowtestservice.YellowTestServiceComponent.le_mrc";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t yellowtestservice_exe_LogSession;
LE_SHARED le_log_Level_t* yellowtestservice_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    yellowtestservice_exe_LogSession = log_RegComponent("yellowtestservice_exe", &yellowtestservice_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_YellowTestServiceComponent.so");
